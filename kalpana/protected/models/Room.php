...
class Room extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('single_bed, double_bed, extra_bed, room_rate, column_11, created_by, updated_by', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->compare('column_11',$this->column_11);
