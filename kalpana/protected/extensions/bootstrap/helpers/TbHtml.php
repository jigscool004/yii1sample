...
return self::tag(
'div', array('class' => 'radio'), self::createCheckBoxAndRadioButtonLabel($label, $input, $labelOptions)
);
} else {
...
if (TbArray::popValue('useContainer', $htmlOptions, false)) {
return self::tag(
'div', array('class' => 'checkbox'), self::createCheckBoxAndRadioButtonLabel($label, $input, $labelOptions)
);
} else {
return self::createCheckBoxAndRadioButtonLabel($label, $input, $labelOptions);
}
...
$items[] = self::tag(
'div', array('class' => 'radio'), self::label($option . ' ' . $label, false, $labelOptions)
);
}
}
...
$items[] = self::tag(
'div', array('class' => 'checkbox'), self::label($option . ' ' . $label, false, $labelOptions)
);
}
}
...
self::addCssClass(
array('btn', 'btn-' . TbArray::getValue('color', $buttonOptions)), $buttonOptions['labelOptions']
);
