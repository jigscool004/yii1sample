...
//        $I->seeNodeText($span, array('Prepend text', 'Append text'));
    ...
    public function testCheckboxList() {
        ...
        $div = $I->createNode($html, 'div');
        $I->seeNodeChildren(
                $div, array('input[type=checkbox]', 'label', 'label', 'label', 'label')
        );
        ...
        $div = $I->createNode($html, 'div');
        $I->seeNodeChildren(
                $div, array('label', 'label', 'label', 'label', 'input[type=checkbox]')
        );
    ...
    public function testInlineCheckBoxList() {
        ...
        $I->seeNodeNumChildren($div, 3);
        $I->seeNodeChildren(
                $div, array('label.checkbox-inline', 'label.checkbox-inline', 'label.checkbox-inline')
        );
    }
    ...
    public function testActiveCheckBoxListControlGroup() {
        ...
        $I->dontSeeNodeCssClass($controls, 'controls');
        $I->seeNodeChildren(
                $controls, array('input[type=hidden]', 'label', 'label', 'label')
        );
    }
    ...
    public function testControls() {
        ...
        $html = TbHtml::controls(
                        '<div class="row"></div><div class="row"></div>', array(
                    'before' => 'Before text',
                    'after' => 'After text',
                        )
        );
