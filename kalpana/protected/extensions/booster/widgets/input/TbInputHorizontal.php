...
class TbInputHorizontal extends TbInput {
    ...
    protected function passfieldField() {
        ...
        echo $this->getPrepend();
        $this->widget(
                'booster.widgets.TbPassfield', array(
            'model' => $this->model,
            'attribute' => $this->attribute,
    ...
    protected function datetimepickerField() {
        ...
        echo $this->getPrepend();
        $this->widget(
                'booster.widgets.TbDateTimePicker', array(
            'model' => $this->model,
            'attribute' => $this->attribute,
            'options' => isset($options) ? $options : array(),
            'events' => isset($events) ? $events : array(),
    ...
    protected function colorpickerField() {
        ...
        echo $this->getPrepend();
        $this->widget(
                'booster.widgets.TbColorPicker', array(
            'model' => $this->model,
            'attribute' => $this->attribute,
            'format' => $format,
            'events' => isset($events) ? $events : array(),
    ...
    protected function redactorJs() {
        ...
        echo '<div class="controls">';
        $this->widget(
                'booster.widgets.TbRedactorJs', array(
            'model' => $this->model,
            'attribute' => $this->attribute,
    ...
    protected function markdownEditorJs() {
        ...
        $this->widget(
                'booster.widgets.TbMarkdownEditorJs', array(
            'model' => $this->model,
            'attribute' => $this->attribute,
            'width' => isset($width) ? $width : '100%',
            'height' => isset($height) ? $height : '400px',
    ...
    protected function html5Editor() {
        ...
        echo '<div class="controls">';
        $this->widget(
                'booster.widgets.TbHtml5Editor', array(
            'model' => $this->model,
            'attribute' => $this->attribute,
            'editorOptions' => isset($options) ? $options : array(),
            'width' => isset($width) ? $width : '100%',
    ...
    protected function dateRangeField() {
        ...
        echo $this->getPrepend();
        $this->widget(
                'booster.widgets.TbDateRangePicker', array(
            'model' => $this->model,
            'attribute' => $this->attribute,
            'options' => isset($options) ? $options : array(),
