...
abstract class TbInput extends CInputWidget {
    ...
    protected function getError() {
        return $this->form->error(
                        $this->model, $this->attribute, $this->errorOptions, $this->enableAjaxValidation, $this->enableClientValidation
        );
    }
    ...
    protected function getSeparatedSelectableInput() {
        ...
        $hasHiddenField = (array_key_exists('uncheckValue', $this->htmlOptions) && $this->htmlOptions['uncheckValue'] === null) ? false : true;
