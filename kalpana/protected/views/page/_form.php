...
<div class="form">
    ...
    <div class="clearfix"></div>
    <div class="col-lg-10">
        <?php echo $form->labelEx($model, 'actions_name', array('class' => 'col-lg-3')); ?>
        <div class="col-lg-7">
            <?php echo $form->textArea($model, 'actions_name', array('size' => 60, 'maxlength' => 255, 'class' => 'form-control')); ?>
            <?php echo $form->error($model, 'actions_name'); ?>
        </div>
    </div>
    <div class="clearfix"></div>
